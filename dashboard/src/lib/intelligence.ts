...
export interface QueueCost {
  ...
  workerHoursConsumed: number;
  estimatedCostUSD: number;     // based on EC2 compute cost
  costPerSuccessfulJob: number;
  wastedCostUSD: number;        // cost of failed/retried work
  wastePercent: number;         // wasted / total
  topCostDriver: string;
}

export const QUEUE_COSTS: QueueCost[] = [
  {
    queueName: 'image-processing',
    jobsToday: 15832,
    successfulJobs: 12041,
    failedJobs: 3791,
    avgDurationMs: 4200,
    workerHoursConsumed: 18.4,
    estimatedCostUSD: 8.28,
    costPerSuccessfulJob: 0.000687,
    wastedCostUSD: 5.62,
    wastePercent: 67.9,
    topCostDriver: 'OOM failures — 3,791 jobs consumed worker time without completing',
  },
  {
    queueName: 'report-generation',
    jobsToday: 892,
    ...
    failedJobs: 47,
    avgDurationMs: 8200,
    workerHoursConsumed: 6.1,
    estimatedCostUSD: 2.74,
    costPerSuccessfulJob: 0.00325,
    wastedCostUSD: 0.31,
    wastePercent: 11.3,
    topCostDriver: 'Long-running jobs (avg 8.2s) — highest cost-per-job of all queues',
  },
  {
    queueName: 'email-notifications',
    jobsToday: 48291,
    successfulJobs: 47902,
    failedJobs: 389,
    avgDurationMs: 88,
    workerHoursConsumed: 1.18,
    estimatedCostUSD: 0.53,
    costPerSuccessfulJob: 0.0000111,
    wastedCostUSD: 0.008,
    wastePercent: 1.5,
    topCostDriver: 'Efficient — no significant waste',
  },
  {
    queueName: 'webhook-dispatch',
    jobsToday: 92847,
    successfulJobs: 92029,
    failedJobs: 818,
    avgDurationMs: 42,
    workerHoursConsumed: 1.08,
    estimatedCostUSD: 0.49,
    costPerSuccessfulJob: 0.0000053,
    wastedCostUSD: 0.011,
    wastePercent: 2.2,
    topCostDriver: 'Most cost-efficient queue — highest throughput/dollar',
  },
  {
    queueName: 'data-sync',
    jobsToday: 7823,
    ...
    failedJobs: 111,
    avgDurationMs: 1200,
    workerHoursConsumed: 2.6,
    estimatedCostUSD: 1.17,
    costPerSuccessfulJob: 0.000152,
    wastedCostUSD: 0.18,
    wastePercent: 15.4,
    topCostDriver: 'Rate-limit retries causing 15% waste',
  },
  {
    queueName: 'pdf-export',
    jobsToday: 1204,
    ...
    failedJobs: 229,
    avgDurationMs: 0,
    workerHoursConsumed: 0,
    estimatedCostUSD: 0,
    costPerSuccessfulJob: 0,
    wastedCostUSD: 0.74,
    wastePercent: 100,
    topCostDriver: 'Queue paused — all costs were waste before pause',
  },
];
